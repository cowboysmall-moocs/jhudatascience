...
The weekday maximum was `r format(max_weekday_steps, scientific = FALSE)` and the weekend maximum 
was `r format(max_weekend_steps, scientific = FALSE)`. The weekday mean was 
...
was `r format(weekend_median, scientific = FALSE)`. There seems to be more activity during the week as you would
